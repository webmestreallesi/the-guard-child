		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2 col-sm-12 col-xs-12 languages">';
					...
					//echo '<li class="lang-item lang-item-39 lang-item-en-ca lang-item-first"><a lang="en-CA" hreflang="en-CA" href="''"./en-ca/allesi-telecom-security-telephony-internet-security-cabling/"><img src="http://www.allesi.ca/wp-content/polylang/en_CA.png" title="English" alt="English"><span style="margin-left:0.3em;">English</span></a></li>';
					echo '</ul>';
				echo '</div>
				<div class="col-md-2 col-sm-12 col-xs-12 languages">';
					//lien espace client
